...
export default function Assignments() {
  ...
  const handleDelete = () => {
    const result = window.confirm(
      "Do you want to proceed to delete the assignment?"
    );
    if (result) {
  ...
  return (
    <div id="wd-assignments">
      ...
      <li className="wd-assignment list-group-item p-0 mb-3 fs-5 border-gray">
        ...
        {console.log("Assignments in Render:", assignments)}{" "}
        {/* Check value in render */}
        {assignments &&
          assignments.map((assignment: any) => (
            <div
              key={assignment._id}
              className="wd-lesson list-group rounded-0"
            >
                ...
                <div className="d-flex align-items-center">
                  <div>
                    {currentUser.role === "FACULTY" && (
                      <FaTrash
                        className="pb-0 me-1 btn-danger"
                        onClick={() => {
                          handleDelete()
